...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('Posts/posts')->with('flash_message', 'Post added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('Posts/posts')->with('flash_message', 'Post updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('Posts/posts')->with('flash_message', 'Post deleted!');
    }
}
