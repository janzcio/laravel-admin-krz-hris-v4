...
<div class="navbar-wrapper">
        <nav class="navbar navbar-default navbar-fixed-top navbar-expand-md" role="navigation">
            <div class="container">
                ...
                ?>
                <a class="navbar-brand" href="<?= $redirect != '' ? $redirect : '/login' ?>">
                    <b>
                    <?php if (Auth::user()): ?>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="nav-link page-scroll" href="#job-hirings">Job Hirings</a></li>
                        <!-- <li><a class="nav-link page-scroll" href="#team">Team</a></li> -->
                        <!-- <li><a class="nav-link page-scroll" href="#testimonials">Testimonials</a></li> -->
                        <!-- <li><a class="nav-link page-scroll" href="#pricing">Pricing</a></<li></li>i> -->
        ...
        <div class="carousel-item active">
            <div class="container">
                ...
                <div class="carousel-image wow zoomIn">
                    <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/laptop.png') }}" alt="laptop"/>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="ibox-content m-b-sm">
                    <div class="text-center p-lg">
                        <h1>Choose a job that's perfect for you</h1>
                        <p>List of job hirings here ..</p>
...
<!-- <section  class="container features">
    ...
    <div class="row">
        ...
        <div class="col-md-6 text-center  wow zoomIn">
            <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/perspective.png') }}" alt="dashboard" class="img-fluid">
        </div>
    ...
    <div class="row features-block">
        ...
        <div class="col-lg-6 text-right wow fadeInRight">
            <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/dashboard.png') }}" alt="dashboard" class="img-fluid float-right">
        </div>
    </div>
</section> -->
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar3.jpg') }}" class="img-fluid rounded-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar1.jpg') }}" class="img-fluid rounded-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar2.jpg') }}" class="img-fluid rounded-circle img-small" alt="">
    ...
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="col-lg-6 text-right m-t-n-lg wow zoomIn">
                <img src="{{ asset('inspinia_admin-v2.9.2/img/landing/iphone.jpg') }}" class="img-fluid" alt="dashboard">
            </div>
    ...
    <div class="container">
        ...
        <div class="row features-block">
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="float-left">
                        <img alt="image" src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar3.jpg') }}  ">
                    </a>
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="float-left">
                        <img alt="image" src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar1.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
            ...
            <div class="col-lg-4">
                ...
                <div class="comments-avatar">
                    <a href="#" class="float-left">
                        <img alt="image" src="{{ asset('inspinia_admin-v2.9.2/img/landing/avatar2.jpg') }}">
                    </a>
                    <div class="media-body">
                        <div class="commens-name">
                            Andrew Williams
