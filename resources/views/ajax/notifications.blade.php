<ul class="nav navbar-top-links navbar-right">
    ...
    @can('can-view-request-for-update')
        <?php if ($rfu > 0): ?>
            <li class="dropdown">
                <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                    <i class="fa fa-bell"></i>  
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    <li class="count-notif">
                        <a href="/profile?rfu=1" class="dropdown-item">
                            <div>
                                <i class="fa {{ $new_applicants == 1 ? 'fa-user' : 'fa-users' }} fa-fw"></i> Please update your profile
                                <span class="float-right text-muted small moment-label"></span>
                            </div>
                        </a>
                    </li>
                    <li class="dropdown-divider"></li>
